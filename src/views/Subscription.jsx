  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='text-center text-4xl mb-16'>
        <h2 className='font-bold text-4xl text-black'>Elige una suscripción...</h2>
      </div>
      <div className='w-7/12 flex '>
        <div className='bg-gray-100 flex flex-col mr-2 p-2'>
          ...
          <p>• Envió sin cargo en caso de compra de libros nuevos y usados.</p>
          ...
          <div className='flex justify-center '>
            <button className='bg-blue-500 rounded p-3 font-bold mb-4 text-white hover:bg-blue-600'>Suscribirse</button>
          </div>
          <p className='text-gray-400 text-xs text-center'>EL PRECIO NO INCLUYE IMPUESTOS VIGENTES EN ARGENTINA.</p>
        </div>
