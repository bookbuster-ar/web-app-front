      ...
      <div className='flex flex-col align-items box-border'>
        {genreStatus === 'loading' ? (
          ...
          genres?.map((genre, index) => (
            <div
              key={index}
              className='text-black text-base rounded-md pl-2 w-96 bg-transparent flex justify-center border outline-none m-1 p-2 hover:border-blue-600 hover:text-blue-600 cursor-pointer'
            >
              {genre.name}
            </div>
          ))
