          ...
          <div className='grid h-full grid-cols-2 grid-rows-12 xl:grid-cols-12 xl:grid-rows-6 lg:grid-cols-12 lg:grid-rows-9 relative'>
              ...
              <Link to='genre/cd49e523-5861-4669-9e26-8766812de9d5'>
                <div className='relative transition-all duration-500 h-full ease-in left-5'>
                  ...
                  <div className='absolute bottom-11 transition-opacity opacity-0 group-hover:opacity-100 max-w-[250px] leading-4 duration-300 text-[10px] text-bluebook'>
                    ...
                    amor, terror, suspenso, policiales, clásicos y
            ...
            <div className='bg-redbook relative col-span-1 xl:col-span-3 row-span-1 xl:row-span-3 lg:col-span-3 lg:row-span-5 text-2xl font-roboto text-yellowbook font-black cursor-pointer group hover:bg-red-200'>
              <Link to='genre/ca9bc2d6-3d43-46d6-96b2-8e99b7453d00'>
                ...
                <div className='absolute bottom-7 transition-opacity opacity-0 group-hover:opacity-100 max-w-[200px] left-5 leading-4 duration-200 text-[10px] text-bluebook'>
                  Relatos en primera persona, periodismo, viajes, investigación
                  y reflexión a través de historias reales.
                </div>
              </Link>
            ...
            <div className='bg-bluebook relative col-span-1 xl:col-span-4 row-span-1 xl:row-span-2 lg:col-span-4 lg:row-span-3 lg:col-start-8 lg:row-start-1 text-xl font-roboto text-white font-black cursor-pointer group hover:bg-blue-200'>
              <Link to='genre/61b1d9bf-f5f0-41bc-9e2c-f236602d8d80'>
                ...
                <div className='absolute bottom-4 transition-opacity opacity-0 group-hover:opacity-100 max-w-[200px] left-5 duration-200 text-[10px] text-bluebook'>
                  Ensayos, pensamiento contemporáneo y clásico, nuevas
                  filosofías, estudios del lenguaje, ambientalismo, economía y
                  sociología.
                </div>
                <div className='absolute opacity-0 group-hover:opacity-100 transition-opacity duration-500 right-3 top-3 w-8 h-8'>
                  <img src={RedMark} alt='Marcador Rojo' />
            ...
            <div className='bg-white relative col-span-1 xl:col-span-3 row-span-1 xl:row-span-2 lg:col-span-3 lg:row-span-2 lg:col-start-1 lg:row-start-8 text-xl font-roboto text-orangebook font-black cursor-pointer group hover:bg-blue-200'>
              <Link to='genre/ac222fdc-e53d-4bbb-8726-03f5dbdd0823'>
                ...
                <div className='absolute bottom-2 transition-opacity opacity-0 group-hover:opacity-100 max-w-[250px] leading-4 left-4 duration-200 text-[10px] text-bluebook'>
                  Literatura infantil, narrativa inicial, audiolibros y
                  historias dibujadas. Juegos y recreos literarios.
                </div>
                <div className='absolute opacity-0 group-hover:opacity-100 transition-opacity duration-500 right-4 top-4 w-8 h-8'>
                  <img src={RedMark} alt='Marcador Rojo' />
                </div>
