...
const PaginationAuthorTitle = ({ author, title }) => {
  ...
  useEffect(() => {
    dispatch(getAuthorTitleByPage({ author: author, title: title, page: currentPage }));
  }, [currentPage, dispatch, author, title]);
...
export default PaginationAuthorTitle;