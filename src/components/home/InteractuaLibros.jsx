...
const InteractuaLibros = () => {
  return (
    <>
      ...
      <div className='text-bluebook text-center relative mb-60 md:mb-20 md:text-start md:ml-14 lg:scale-125 lg:mb-36 lg:ml-36 xl:scale-[1.75] xl:mb-72 xl:ml-80'>
        ...
        <div className='absolute'>
          <img
            className='md:w-36 mt-2 md:ml-12 lg:w-36 md:h-8 hidden sm:inline'
            src={LinePink}
            alt='Rayado rosa'
          />
          <img
            className='h-7 w-24 md:w-32 mt-2 ml-2 md:ml-48 lg:w-36 md:h-6 sm:hidden'
            src={LinePinkRev}
            alt='Rayado rosa'
          />
        </div>
      </div>
      <div className='absolute w-12 h-12 md:h-14 md:w-14 ml-32 mb-32 md:mb-[270px] md:ml-[644px] lg:h-16 lg:w-16 lg:mb-96 lg:ml-[854px] xl:w-20 xl:h-20 xl:ml-[1205px] xl:mb-[565px]'>
        <img src={Asterisc} alt='Circulo amarillo sobre el libro de la chica' />
      </div>
      <div className='absolute'>
        <img
          className='h-16 mr-48 mb-6 md:h-14 md:mb-8 md:ml-[455px] lg:h-16 lg:mb-11 lg:ml-[604px] xl:h-24 xl:mb-16 xl:ml-[840px]'
          src={Heart}
